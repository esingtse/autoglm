...
model_config = ModelConfig(
    ...
    # 可选：gemini-2.5-pro / gemini-2.5-flash / gemini-2.0-flash 等多模态模型
    model_name="gemini-3.1-pro-preview",
    api_key=os.environ.get("GEMINI_API_KEY", "AIzaSyCY1UfkZRg5jZl9c2DDN9E47GoslWW37RA"),
    # Gemini 的 OpenAI 兼容层不支持 frequency_penalty，置 0 避免报错
...
agent = PhoneAgent(
    ...
    agent_config=AgentConfig(lang="cn",verbose=True),
)
